class Queue:
    ...
    Kolejka to struktura danych, która działa na zasadzie "first in, first out" (FIFO).
    Elementy są dodawane na końcu kolejki i usuwane z początku kolejki.
    ...
    def is_empty(self):
        ...
        Returns:
            True, jeśli kolejka jest pusta; False w przeciwnym razie.
        """
